...
export function Components() {
  ...
  const validComponentIds = useMemo(() => new Set<string>(componentRegistry.map((c) => c.id)), []);
...
/>`}
            ...
            <Card label="Error State">
              <div className="demo-col">
                <Input
                  ...
                  aria-label="Invalid input example"
                />
              </div>
            </Card>
            <Card label="Disabled">
        ...
        <section id="inputgroup" className="demo-section" style={{ animationDelay: "180ms" }}>
          <SectionHead
            num="03"
            title="InputGroup & InputAddon"
            description="Wrap Input with left or right addons (prefixes, suffixes)."
          />
          <ComponentGrid>
              ...
              <div className="demo-row">
                <InputGroup>
                  ...
                  <Input
                    ...
                    style={{ paddingLeft: "60px", paddingRight: "48px" }}
                    aria-label="URL"
                  />
        ...
        <section id="field" className="demo-section" style={{ animationDelay: "200ms" }}>
          <SectionHead
            num="04"
            title="Field"
            description="Form field primitives: FieldLabel, FieldDescription, FieldErrorText."
          />
          <ComponentGrid>
        ...
        <section id="textfield" className="demo-section" style={{ animationDelay: "240ms" }}>
          ...
          <ComponentGrid>
            ...
            <Card label="Required">
              <div className="demo-col">
                <TextField label="Company" placeholder="Acme Inc" isRequired />
              </div>
            </Card>
          </ComponentGrid>
        </section>
  ...
  {(item) => <SelectItem id={item.id} textValue={item.name}>{item.name}</SelectItem>}
        ...
        <section id="popover" className="demo-section" style={{ animationDelay: "360ms" }}>
          <SectionHead
            num="08"
            title="Popover"
            description="Floating content panel. Use with DialogTrigger."
          />
          <ComponentGrid>
        ...
        <section id="dialog" className="demo-section" style={{ animationDelay: "400ms" }}>
          <SectionHead
            num="09"
            title="Dialog, Modal, AlertDialog"
            description="Modal overlays. Use DialogTrigger + Modal + Dialog or AlertDialog."
          />
          <ComponentGrid>
        ...
        <section id="dropdown" className="demo-section" style={{ animationDelay: "440ms" }}>
          <SectionHead
            num="10"
            title="DropdownItem"
            description="List item for Select/ComboBox. Rendered via SelectItem, ComboBoxItem."
          />
          <ComponentGrid>
          ...
          <ComponentGrid>
            ...
            <Card label="Multiple Selection">
              <div className="demo-lb-wrap">
                <UIListBox
                  listId="lb-multi"
                  ariaLabel="Chemical elements (multiple)"
                  items={ELEMENTS}
              ...
              <div className="demo-lb-actions">
                <button className="demo-action-btn" onClick={multi.selectAll}>
                  Select All
                </button>
                <button className="demo-action-btn" onClick={multi.deselectAll}>
                  Clear
                </button>
              </div>
            </Card>
            <Card label="With Disabled Items">
              <div className="demo-lb-wrap">
                <UIListBox
                  listId="lb-disabled"
                  ariaLabel="Chemical elements (some disabled)"
        ...
        <section id="hooks" className="demo-section" style={{ animationDelay: "540ms" }}>
          <SectionHead
            num="13"
            title="Hooks"
            description="useListState, useItemSelection — state management for list components."
          />
          <ComponentGrid>
            <Card label="useListState" full>
              <div className="demo-col">
                <p style={{ fontSize: 13, color: "var(--d-text-mid)", marginBottom: 12 }}>
                  Manages items, selectedKeys, and provides setSelectedKeys, selectAll, deselectAll.
                  Used by UIListBox demos above.
                </p>
                <div className="demo-lb-wrap">
                  <UIListBox
                    listId="lb-hooks"
                ...
                {single.selectedKeys.size > 0 && (
                  <div className="demo-selection-info">
                    selectedKeys: [{Array.from(single.selectedKeys).join(", ")}]
                  </div>
                )}
              </div>
            </Card>
        ...
        <section id="checkbox" className="demo-section" style={{ animationDelay: "560ms" }}>
          <SectionHead
            num="15"
            title="Checkbox"
            description="Single and group checkboxes for multi-select options."
          />
          <ComponentGrid>
            ...
            <Card
              label="CheckboxGroup"
              code={`<CheckboxGroup label="Preferences" defaultValue={['email']}>
  ...
  <Checkbox value="push">Push</Checkbox>
        ...
        <section id="radio" className="demo-section" style={{ animationDelay: "580ms" }}>
          <SectionHead
            num="16"
            title="Radio"
            description="Radio group for single selection from mutually exclusive options."
          />
          <ComponentGrid>
            <Card
              label="RadioGroup"
              code={`<RadioGroup label="Size" defaultValue="m">
    ...
    <TabPanel id="security">Security settings...</TabPanel>
            ...
            >
              <div className="demo-col" style={{ minWidth: 280 }}>
                <Tabs>
                  ...
                  <TabPanels>
                    <TabPanel id="general">
                      <p style={{ fontSize: 13, color: "var(--d-text-dim)" }}>
        ...
        <section id="disclosure" className="demo-section" style={{ animationDelay: "640ms" }}>
          <SectionHead
            ...
            description="Collapsible sections and accordion groups."
          />
          <ComponentGrid>
            <Card
              label="Single Disclosure"
              code={`<Disclosure>
  ...
  <DisclosurePanel>Details about system requirements here.</DisclosurePanel>
            ...
            <Card
              label="Accordion (DisclosureGroup)"
              full
...
/>`}
        ...
        <section id="progressbar" className="demo-section" style={{ animationDelay: "700ms" }}>
          ...
          <ComponentGrid>
            <Card
              label="Determinate"
              code={`<ProgressBar label="Upload" value={65} maxValue={100} />`}
            >
        ...
        <section id="badge" className="demo-section" style={{ animationDelay: "720ms" }}>
          ...
          <ComponentGrid>
            <Card
              label="Variants"
              code={`<Badge variant="neutral">Draft</Badge>
...
<Badge variant="info">New</Badge>`}
        ...
        <section id="numberfield" className="demo-section" style={{ animationDelay: "740ms" }}>
          <SectionHead
            num="24"
            title="NumberField"
            description="Numeric input with increment/decrement steppers."
          />
          <ComponentGrid>
            <Card
              label="Basic"
              code={`<NumberField label="Quantity" defaultValue={5} minValue={0} maxValue={100} />`}
            >
        ...
        <section id="taggroup" className="demo-section" style={{ animationDelay: "800ms" }}>
          <SectionHead
            num="27"
            title="TagGroup"
            description="Removable tags with keyboard navigation."
          />
          <ComponentGrid>
            <Card
              label="Basic"
              code={`<TagGroup label="Tags">
  <Tag>News</Tag>
  <Tag>Travel</Tag>
  <Tag>Gaming</Tag>
</TagGroup>`}
