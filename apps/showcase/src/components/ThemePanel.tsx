...
export function ThemePanel({
  ...
  const activePresetVars =
    activePresetId === "custom"
      ? initialVars
      : (presets.find((p) => p.id === activePresetId)?.vars ?? initialVars);
  ...
  const handleImport = async (event: ChangeEvent<HTMLInputElement>) => {
    ...
    showToast(
      imported.warnings.length > 0 ? "Theme imported with warnings" : "Theme imported",
      ...
      <div className="demo-theme-panel-body">
            ...
            {presets.map((preset) => (
              ...
              >
                <div
                  ...
                  style={{ background: preset.vars["--aria-accent"] }}
                />
        ...
        {filteredSections.map((section) => (
          <section key={section.id} className="demo-theme-section">
            <h3>{section.title}</h3>
            <div
              className={section.layout === "grid" ? "demo-theme-controls-grid" : "demo-theme-row"}
            >
        ...
        <section className="demo-theme-section-accessibility">
          <div className="demo-accessibility-header">
            <h3>Accessibility</h3>
            <div
              className={`demo-a11y-score ${accessibilityScore === 100 ? "perfect" : accessibilityScore >= 80 ? "good" : "needs-work"}`}
            >
          ...
          <div className="demo-theme-contrast-list">
            {contrastReport.map((item) => (
              <div
                key={item.label}
                className={`demo-contrast-item ${item.aaPass ? "pass" : "fail"}`}
              >
                <div className="demo-contrast-info">
                  <span className="demo-contrast-label">{item.label}</span>
                  <span className="demo-contrast-ratio">
                    {item.ratio ? item.ratio.toFixed(2) : "n/a"} : 1
                  </span>
                </div>
        ...
        <section className="demo-theme-section-export">
          ...
          <div className="demo-theme-actions">
            <Button variant="primary" size="sm" onPress={copyCss}>
              ...
              >
                <path
                  d="M13.333 6H7.333C6.597 6 6 6.597 6 7.333v6C6 14.07 6.597 14.667 7.333 14.667h6c.737 0 1.334-.597 1.334-1.334v-6C14.667 6.597 14.07 6 13.333 6z"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
            ...
            <Button variant="secondary" size="sm" onPress={downloadCss}>
              ...
              >
                <path
                  d="M8 2v8m0 0l-3-3m3 3l3-3M2 10v2a2 2 0 002 2h8a2 2 0 002-2v-2"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
          ...
          <input
            ...
            className="demo-theme-hidden-input"
