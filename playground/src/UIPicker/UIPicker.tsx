          ...
          <div className="p-4 outline-none">
            <div className="space-y-3">
              <Autocomplete filter={contains}>
                ...
                >
                  <ListBoxItem className={itemStyles}>Aardvark</ListBoxItem>
                  <ListBoxItem className={itemStyles}>Cat</ListBoxItem>
                  <ListBoxItem className={itemStyles}>Dog</ListBoxItem>
                  <ListBoxItem className={itemStyles}>Kangaroo</ListBoxItem>
                  <ListBoxItem className={itemStyles}>Panda</ListBoxItem>
                  <ListBoxItem className={itemStyles}>Snake</ListBoxItem>
                </ListBox>
              </Autocomplete>
            </div>
          </div>
