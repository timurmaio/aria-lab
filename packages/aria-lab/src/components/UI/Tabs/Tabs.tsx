...
export function Tabs({ children, className, ...props }: TabsProps) {
  return (
    <AriaTabs className={composeClassName(className, () => cn(tabsBase))} {...props}>
      {children}
    </AriaTabs>
  );
}
...
export function TabList<T extends object>({ children, className, ...props }: TabListProps<T>) {
  return (
    <AriaTabList className={composeClassName(className, () => cn(tabListBase))} {...props}>
      {children}
    </AriaTabList>
  );
}
...
export function Tab({ children, className, ...props }: TabProps) {
  return (
    <AriaTab className={composeClassName(className, () => cn(tabBase))} {...props}>
      {children}
    </AriaTab>
  );
}
...
export function TabPanel({ children, className, ...props }: TabPanelProps) {
  return (
    <AriaTabPanel className={composeClassName(className, () => cn(tabPanelBase))} {...props}>
      {children}
    </AriaTabPanel>
  );
}
