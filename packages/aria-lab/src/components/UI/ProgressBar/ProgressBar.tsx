...
const trackBase = "relative h-2 w-full rounded-full bg-[var(--aria-bg-secondary)] overflow-clip";

const fillBase = "h-full rounded-full bg-[var(--aria-accent)] transition-[width] duration-200";
      ...
      {({ percentage, valueText, isIndeterminate }) => (
        <>
          ...
          <div className={cn(trackBase, "min-h-[8px]")} aria-hidden>
            <div
              className={cn(fillBase, isIndeterminate && "animate-pulse opacity-80")}
              style={
                {
