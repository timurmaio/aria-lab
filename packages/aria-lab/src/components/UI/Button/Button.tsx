...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  link: "h-auto border-transparent bg-transparent px-0 text-[var(--aria-accent)] underline-offset-4 hover:underline",
  destructive: "border-transparent bg-[var(--aria-error)] text-white hover:brightness-95",
};
